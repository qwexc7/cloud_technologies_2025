...
В хорошем докерфайле изменили на ```FROM python:3.9-slim``` - фиксированная версия , уже содержит Python , поэтому не нужно устанавливать вручную 
Что улучшилось: стабильная сборка 
